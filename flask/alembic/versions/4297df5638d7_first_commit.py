...
def upgrade():
    ...
    sa.Column('alg_name', sa.String(), nullable=True),
    ...
    sa.Column('gn_ref_id', sa.String(), nullable=True),
    sa.Column('gn_prefix', sa.String(), nullable=True),
    sa.Column('sp_id', sa.Integer(), nullable=True),
    ...
    sa.Column('ort_is_best', sa.Boolean(), nullable=True),
    ...
    sa.Column('ort_id', sa.Integer(), nullable=True),
