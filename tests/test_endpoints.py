...
class testEndpoints(unittest.TestCase):
    ...
    def test_get_species_homologs_list(self):
        rv = self.app.get('/agr-service/get_species_homologs_list?hom_ids=75338&hom_ids=75341&hom_ids=75340')
    ...
    def test_get_orthologs_by_symbol():
        rv = self.app.get('/agr-service/get_orthologs_by_symbol/1110017D15Rik%2C1110032A03Rik%2C1700001L19Rik/Mus%20musculus/Homo%20sapiens')
        assert len(rv.json) == 3
    ...
    def test_get_intersect_by_homology(self):
        rv = self.app.get('/agr-service/get_intersect_by_homology?gs1=329155&gs1=WBGene00011502&gs1'
